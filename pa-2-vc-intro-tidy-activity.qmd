...
**NAMES:** Emme, Vv, and Samreen


```{r}
#| label: add-tidyverse-package
...
```{r}
#| label: create-single-vector
# combine previous vectors into a single vector
...
```{r}
#| label: altering-numbers
#altering the top secret set of numbers
...
```{r}
#| label: checking-value-checkpoint
#verify there are 352 numbers below 17
